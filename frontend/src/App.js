    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white shadow-lg">
        <div className="p-4 bg-indigo-600 text-white">
          <h1 className="text-lg font-semibold">Clínica & Farmacia</h1>
          <h2 className="text-base font-medium">PEDIATRICA</h2>
          <p className="text-xs text-indigo-200">by Dr. Argueta & Dra. Nely</p>
      ...
      <div className="flex-1 overflow-auto">
        ...
        {activeView === 'appointments' && (
          <AppointmentsView 
            ...
            headers={headers}
            refreshDashboard={refreshDashboardData}
            setSelectedPatientForView={setSelectedPatientForView}
          />
        )}
        {activeView === 'pharmacy' && (
          <PharmacyView 
...
const DashboardView = ({ pacientes, medicamentos, citas, ventasHoy, alertasFarmacia, setActiveView }) => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow cursor-pointer hover:bg-gray-50" onClick={() => setActiveView('appointments')}>
          <div className="flex items-center">
